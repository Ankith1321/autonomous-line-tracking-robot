...
def generate_launch_description():
    arguments = [
        ...
        DeclareLaunchArgument('clear_confirm_frames', default_value='3'),
        DeclareLaunchArgument('turn_time_sec', default_value='1.20'),
        DeclareLaunchArgument('forward_time_sec', default_value='1.50'),
        DeclareLaunchArgument('turn_speed', default_value='0.32'),
        DeclareLaunchArgument('emergency_turn_speed', default_value='0.42'),
        DeclareLaunchArgument('forward_speed', default_value='0.035'),
